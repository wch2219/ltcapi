 ...
 * Druid数据源配置
 * @author tangjingyuan
 * @Email 1170968866@qq.com
 *
 */
@Configuration
@EnableTransactionManagement // 启注解事务管理
@MapperScan(basePackages = " com.example.vueservcedemo.mapp", sqlSessionFactoryRef = "SqlSessionFactory")
...
//	}
    ...
    public SqlSessionFactory sqlSessionFactoryBean() throws Exception {
        ...
        // 实体返回映射
        sqlSessionFactoryBean.setTypeAliasesPackage("com.example.vueservcedemo.model");
        // sql xml文件路径
